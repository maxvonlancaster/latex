...
% sortie de page
%
\pageheight=\vsize\advance\pageheight by 2cm

\musicsize=16\relax
\def\lppage{7}%
\ifx\gros\undefined\font\gros=\fonthdg\fonthdge bx10 scaled \magstep2\fi
 %
 %
\voffset-30mm
%
\def\outmorc{\shipout\vbox to \pageheight{\vfil\pagecontents\vfil\line{%
\ifodd\pageno\sl Pacifique (D. Taupin) \rm$\copyright$\hss \number\pageno
\else\rm\number\pageno\hss\sl Pacifique (D. Taupin) \rm$\copyright$\fi}}%
...
%
\centerline{\gros Pacifique}
\medskip
\line{Compos\'e en 1972, \sl San Jose (Calif.)\hss Daniel TAUPIN}
\smallskip
\line{\sl r\'ev. mai  1981, janvier 1990\hss\`a Christiane}
\bigskip
%\tracingstats=2\relax
%
\nbporteesi=2\relax
...
%\check
%
\def\arpg#1#2{\vnotes 0.2\elemskip\arpeggio{#1}{#2}\enotes}
\def\Arpg#1#2{\vnotes 0.2\elemskip
  \off{-\internote}\larpeggio{#1}{#2}\off{\internote}\enotes}
\def\uarpg#1#2{\vnotes 0.2\elemskip\nextstaff\arpeggio{#1}{#2}\enotes}
\def\uArpg#1#2{\vnotes 0.2\elemskip\nextstaff
  \off{-\internote}\larpeggio{#1}{#2}\off{\internote}\enotes}
%
% soufflets crescendo
...
%
\debutmorceau\autolines 95{\lppage}\relax
%
...
% mesure 3
\barre\notes\zcharnote{-5}{\Ped\ \it simile}\zh{Mb}\hl d|\Tleg0\qu k\sk\Ilegl0d\dqh4ik\enotes
...
\temps\NOtes\pointdorgue d\bohu K|\pointdorgue o\zh{hk}\bohl m\cbreath\enotes
% mesure 103
...
\generalmeter{\meterfrac 54}\relax\changecontext
...
% mesure 133
\barre\Notes\bohu H\ifx\mxversion\undefined\Tleg0\relax
                    \else\tslur0b\relax
                    \fi|\hl c\enotes
...
\ifx\mulooseness\undefined\else\mulooseness=-2\fi
...
\transpose=-7\relax
%
\ifx\mulooseness\undefined\else\mulooseness=0\fi
...
%\check
\transpose=0\relax
\barre\autolines {25}2{\lppage}\relax
...
\temps\notes\Ibu0fg4\bsqh f|\motif\enotes
...
\autolines {23}2{\lppage}\relax
\temps\notes\Ibu0jh4\bsqh k|\motif rqpm\enotes
\notes\tbsqh i|\motif rqpm\enotes
\temps\notes\Ibu0ig4\bsqh j|\motif qpom\enotes
\notes\tbsqh h|\motif qpom\enotes
%\check
% mesure 164
\generalmeter{\meterfrac 34}\changecontext
\notes\Ibu0hf4\zq d\qh0i|\motif pon{=l}\enotes
\notes\tbsqh g|\motif ponl\enotes
\temps\NOtes\zh b\zh{=e}\hu g|\Motif ponl\enotes
%\check
% mesure 165
\generalmeter{\meterfrac 44}\changecontext
\autolines {26}2{\lppage}\relax
\notes\Ibu0hf4\bsqh i|\octline t\motif ponk\enotes
\notes\tbsqh g|\motif ponk\enotes
\temps\notes\Ibu0ge4\bsqh h|\motif onmj\enotes
...
\temps\notes\Ibu0jl4\bsqh j|\motif srqm\enotes
\Notes\fl g\tbsqh l|\multnoteskip{.8}\motif srqm\enotes
%
% mesure 168
...
% mesure 200
\linesinpage=0\relax
\barno=200\relax\autolines 95{\lppage}\relax
