...
\def\staffspacingiii{0.64}\def\interinstrumentiii{0pt}\relax
 ...
 %
\font\gros=\fonthdg\fonthdge bx12 scaled \magstep2
\font\paroles=\fonthdg\fonthdge r8
...
\def\atnextline{\sanspedale\def\nbinstruments{2}\savemeters}%
 %
%Takt 13
\barre\notes\zcharnote B{\kern -2\Interligne\rm(P‚d.)}\zhl K\relax
...
\temps\notes\zcharnote C{\bf I \rm(G.O.)}\soupir|\Tqh fda&\relax
  \zmid{Verbe ‚-}\clp M\sk\ccl M\enotes
%Takt 14
\barre\notes\hu F|\Qqh cdfda&\zmid{gal}\hl a\enotes
\temps\notes\hu H|\Qqh {=b}ceca&\zmid{au}\qlp N\sk\sk\sk\zmid{TrŠs-}\sk\cl N\enotes
%Takt 15
...
Jb\sk\sk\zmid{de la}\zq J\cl b\sk\zq J\cl b&\zq {=d}\qu f\sk
 ...
 %\check
%Takt 42
\barre\notes\wh M&\sdqh cc\sdqh cc|\zq f\qu h\sk\sk\zq f\qu h&\zmid{grƒ-}\zhl
...
\temps\notes\zmidtwotext{\kern -2\Interligne\bf I \rm(G.O.)}\Dnu ML|\relax
 ...
 %\check
%Takt 56
\barre\notes\Hu K\zcharnote I{(+P‚d.)}|\sdqh bf\itenu1i\zqu i\Tqb ifb&\hl b\sk
  \zmid{qui}\sk\qu b&\hpause\enotes
\temps\notes\Hu J\zcharnote I{(+P‚d.)}|\tten1\zqu i\raise -2\Interligne\ds
  \dqb bf\zqu {_h}\qsk
...
\temps\notes\dnu LK|\zqu i\Sqb gbegeb&\zmid{ta}\zql L\hu b\sk\sk
  \zmid{gloi-}\ql K&\zmid{fre,}\zq e\qu g\sk\sk\zmid{…}\qu i\enotes
 %\check
%Takt 70
