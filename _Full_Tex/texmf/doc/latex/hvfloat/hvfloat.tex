...
\usepackage{lscape}
\usepackage{multicol}
\usepackage[pdftitle={hvfloat - Rotating Objects and Captions}, pdfauthor={Herbert Voﬂ}, urlcolor=blue, linktocpage, a4paper, colorlinks=true]{hyperref}
%
...
\author{Herbert Voﬂ\thanks{\protect\url{voss@perce.de}}}
\date{\today}
\maketitle
