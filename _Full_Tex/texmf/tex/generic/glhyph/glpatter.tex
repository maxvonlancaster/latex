% This is the file glpatter.tex, version 2.4
...
\keepcomments
% This is the file glhyph.tex, version 2.4
...
\template{.des2# \newline}  %Prefixos dubidosos ou que xa non se notan. Non se inclúen os que por ser moi breves poderían coincidir con prefixos .des formados ad hoc, xa que impedirían a división de palabras comúns (desecar, deselar).
